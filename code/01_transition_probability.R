...
# fig_combine
ggsave(filename = "output/supl.fig2_smooth_probability.svg", plot=fig_combine, width=10, height = 6)
...
# fig_combine
ggsave(filename = "output/supl.fig3_observed_probability.svg", plot=fig_combine, width=10, height = 6)
